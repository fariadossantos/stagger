...
<html lang="en">
  ...
  <body class="w3-margin-top">
    <div class="w3-dark-grey " >
      <div class="w3-row w3-light-grey " style=" width:30%; margin:0 auto; " >
        <!-- NAVAGATION BAR -->
        <div class="">
          <nav class="">
            <ul class="w3-navbar w3-white w3-center w3-padding  ">
              <a href="index.php">  <span class="w3-hover-dark-grey w3-padding w3-left w3-round w3-text-grey">
                  <i class="material-icons">arrow_back</i></span></a>
                  <a href="index.php">  <span class="w3-hover-dark-grey w3-padding w3-right w3-round w3-text-grey">sign up</span></a>
                <!--
              <li style="width:20%"><a class="w3-hover-light-grey" href="#"><i class="material-icons">home</i></a></li>
              <li style="width:20%"><a class="w3-hover-light-grey" href="#"><i class="material-icons">search</i></a></li>
              <li style="width:20%"><a class="w3-hover-light-grey" href="#"><i class="material-icons">chat</i></a></li>
              <li style="width:20%"><a class="w3-hover-light-grey" href="#"><i class="material-icons">person</i></a></li>
              <li style="width:20%"><a class="w3-hover-light-grey" href="#"><i class="material-icons">camera</i></a></li>
                -->
            </ul>
          </nav>
        </div>
          ...
          <div class="w3-row  w3-white">
            <p class="w3-white" style="margin:0; ">
              ...
              <ul class="w3-navbar w3-white w3-center w3-small">
                ...
                <li style="width:25%"><a  class="w3-hover-white w3-hover-text-dark-grey w3-text-grey" href="#"><i><i class="material-icons">share</i></i></a></li>
                <li style="width:25%"><a class="w3-hover-white w3-hover-text-dark-grey w3-text-grey" href="#"><i><i class="material-icons">favorite</i></i></a></li>
                <li style="width:25%"><a class="w3-hover-white w3-hover-text-dark-grey w3-text-grey" href="#"><i><i class="material-icons">chat</i></i></a></li>
              </ul>
            </p>
          </div>
        </div>
