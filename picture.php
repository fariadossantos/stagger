    ...
    <div class="w3-dark-grey " >
      <div class="w3-row w3-light-grey w3-container w3-padding " style=" width:30%; margin:0 auto; " >
            ...
            <div class="">
              ...
              <span class="w3-hover-dark-grey w3-padding w3-right w3-round w3-text-grey"><i class="material-icons">arrow_forward</i></span>
              <br><br><br><br><br><br>
              <div class="w3-circle w3-blue-grey w3-center" style="width:70px; height:70px; margin:0 auto;">
